...
-metoda brutalna - opiera się na generowaniu wszystkich ścieżek pomiędzy
				...
				chwili wnoszą największe pokrycie - O(n^3 + n^2)
-metoda zoptymalizowana - opiera się na pojęciu średnicy grafu - w każdej 
				...
				dla dwóch dotąd niepokrytych liści - O(n^2)
...
- w ten sposób otrzymamy graf acykliczny, czyli drzewo (wierzchołki są numerowane 1...n) 